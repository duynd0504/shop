     ...
     <div class="col-lg-12">
             <section class="panel">
                 ...
                 {{-- <?php 
                    ...
                    if($message){
                        echo '<h4 style="text:align center">'. $message. '</h5>';
                 ...
                 <div class="panel-body">
                     ...
                     <form role="form" action="{{URL::to('/save-brand-product')}}" method="POST">
                         ...
                         <div class="form-group">
                             ...
                             <textarea style="resize: none" name="brand_product_desc" class="form-control" id="exampleInputPassword1" placeholder="Mô tả"> </textarea>
                         </div>
                         <div class="form-group">
